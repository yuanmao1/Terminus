...
const bool_flags = [_][]const u8{ "json", "from-cursor", "no-enter", "raw", "no-daemon", "dry-run", "delete", "force", "stdin", "login", "append", "strict", "include-keys", "active", "from-log", "read-only", "show-script", "all" };
